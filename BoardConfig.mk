...
BOARD_KERNEL_CMDLINE := console=ttyMSM0,115200n8 androidboot.hardware=qcom androidboot.console=ttyMSM0 lpm_levels.sleep_disabled=1 msm_rtb.filter=0x237 service_locator.enable=1 swiotlb=1 androidboot.usbcontroller=a600000.dwc3 earlycon=msm_geni_serial,0x880000 loop.max_part=7
...
BOARD_X2_DYNPART_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_X2_DYNPART_PARTITION_LIST := odm product system system_ext vendor

# Partitions - FileSystem
$(foreach p, $(call to-upper, $(BOARD_X2_DYNPART_PARTITION_LIST)), \
